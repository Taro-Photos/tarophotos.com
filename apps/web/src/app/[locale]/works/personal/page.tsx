...
export default function PersonalWorksPage() {
  const personalSeries = workSeries.filter(series => series.category === "Personal");
    ...
    <div className="w-full">
      ...
      <section className="py-12 border-t border-gray-100 dark:border-gray-800">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 max-w-7xl mx-auto">
          {personalSeries.map((series, index) => (
            <div key={series.slug} className="contents">
              ...
              >
                <span className="text-sm font-light tracking-[0.2em] text-gray-500 dark:text-gray-400">PERSONAL</span>
